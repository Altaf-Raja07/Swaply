    ...
    <>
      ...
      <main>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-stack-lg items-center">
            <div className="z-10">
              ...
              <div className="flex flex-wrap gap-stack-md">
                <Button variant="primary" size="lg" onClick={() => console.log("CTA clicked")}>
                  Start swapping skills
                </Button>
                <Button variant="secondary" size="lg" onClick={() => console.log("CTA clicked")}>
                  How it works
                </Button>
              </div>
            </div>
        ...
        <section className="py-24 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
          ...
          <ul className="grid grid-cols-2 md:grid-cols-4 md:grid-rows-2 gap-gutter">
            {/* Coding: Big Card */}
            <li className="col-span-2 row-span-1 md:row-span-2">
              <article className="group cursor-pointer bg-surface-container-lowest border border-outline-variant/30 rounded-xl overflow-hidden whisper-shadow active-press" onClick={() => console.log("Category clicked")}>
        ...
        <section className="bg-surface-container-low py-24">
          ...
          <ul className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-3 gap-gutter">
            {/* Quote 1 */}
            <li>
              <figure className="bg-surface-container-lowest p-8 rounded-xl whisper-shadow relative border border-outline-variant/10">
                ...
                <figcaption className="flex items-center gap-stack-md">
            ...
            {/* Quote 2 */}
            <li>
              <figure className="bg-surface-container-lowest p-8 rounded-xl whisper-shadow relative border border-outline-variant/10 md:mt-12">
                <div className="text-primary flex gap-0.5 mb-4">
                  {[...Array(4)].map((_, i) => (
                    <span
                      key={i}
        ...
        <section className="py-32 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto text-center">
          <div className="max-w-3xl mx-auto border-t border-outline-variant pt-24">
            ...
            <Button variant="primary" size="lg" className="inline-flex items-center gap-2" onClick={() => console.log("CTA clicked")}>
              Start swapping skills
